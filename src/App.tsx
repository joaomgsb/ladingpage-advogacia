                ...
                <div className="space-y-6">
                  {[
                    ...
                    },
                    {
                      ...
                      institution: 'Secretaria da Fazenda - Prefeitura de Betim',
                      description: 'Atuação no Setor de ITBI e IPTU',
                      icon: ScrollText,
                    },
                    {
                      title: 'Controle de Pagamentos',
                      institution: 'Prefeitura Municipal de Betim',
                      description: 'Responsável pelo controle de pagamento de contratos municipais incluindo aluguel, água, luz, telefone e prestação de serviços em geral',
                      icon: ScrollText,
                    },
                    {
                      title: 'Analista do Setor de ITBI e IPTU',
                      institution: 'Secretaria da Fazenda - Prefeitura de Betim',
                      description: 'Atuação específica na análise e processamento de ITBI e IPTU',
                      icon: ScrollText,
                    },
                    {
                      title: 'Chefe de Divisão de Serviços Gerais',
                      institution: 'Prefeitura Municipal de Betim',
                      period: '1993',
                      description: 'Cargo em substituição',
                      icon: Building2,
                    },
                    {
                      title: 'Chefe de Divisão de Indústria',
                      institution: 'Prefeitura Municipal de Betim',
                      period: '1992',
                      description: 'Substituição por três meses. Responsável pelo controle de pagamento de contratos municipais (aluguel, água, luz, telefone e serviços)',
                      icon: Building2,
                    },
                    {
